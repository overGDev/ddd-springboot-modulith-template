...
> `DatabaseRoleSeparationTest` connects with the application's own datasource and asserts that `ddd_app` can write rows and cannot change the schema.
...
[docs/testing.md](docs/testing.md) covers the test harness, what the platform tests assert, and where tests live.
